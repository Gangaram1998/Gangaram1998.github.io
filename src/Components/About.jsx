...
import "../Components/ComponentsStyles/about.css";
...
const About = () => {
  ...
  const handleClickButton1 = () => {
    ...
    setButton2Clicked(false); // Enable button 2
  };

  const handleClickButton2 = () => {
    setButton2Clicked(true);
    setButton1Clicked(false); // Enable button 1
  };
  const TimeLineColor = useColorModeValue("#000", "#fff");
  return (
    <Box
      className="section"
      id="aboutpage"
    ...
    >
      ...
      >
        All <span className="AboutExperience">About</span> Me and My{" "}
        <span className="AboutExperience">Experience</span>
      </Heading>
      <Box marginBottom={12}>
        <Button
          background={"#dc143c"}
          ...
          color={button1Clicked === true ? "white" : "black"}
          _hover={{ color: "white", backgroundColor: "#dc143c" }}
          backgroundColor={button1Clicked === true ? "#dc143c" : "gray.200"}
          fontFamily={"Signika Negative, sans-serif"}
        >
          About Me
        </Button>
        <Button
          ...
          color={button2Clicked === true ? "white" : "black"}
          backgroundColor={button2Clicked === true ? "#dc143c" : "gray.200"}
          _hover={{ color: "white", backgroundColor: "#dc143c" }}
          fontFamily={"Signika Negative, sans-serif"}
        >
          Experience
        ...
        >
          {button1Clicked && !button2Clicked && (
            <ul>
              <li>
                <p>
                  Hello! My name is Gangaram Gawade. I enjoy creating things that
                  live on the internet. I am a passionate Software Developer,
                  with strong administrative and communication skills. Good
                  Attention to details and the ability to write clean and
                  efficient code.
                </p>
              </li>
              <br />
              <li>
                <p>
                  I completed my Bachelor of Technology from the Shivaji University,
                  Kolhapur, during the period of 2019-2024, specializing in Mechanical Engineering.
                </p>
              </li>
              <br />
              <li>
                <p>
                  I joined Neosao Services
                  Private Limited as a Software Developer in July 2022. Since
                  then, I have been working with Neosao Services.
                </p>
              </li>
            </ul>
          )}
          {!button1Clicked && button2Clicked && (
            <ul>
              {/* <li>
                <p>Max Bupa Health Insurance (Jan 2021 - Dec 2021)</p>
                <p>Web Developer</p>
                <p>
                  I have contributed significantly to the development of various
                  technological products, including an Employee Management
                  System, Policy Booking System, and the company's primary
                  website. My pivotal role in crafting these tech solutions has
                  effectively addressed the company's business challenges,
                  consequently enhancing its revenue streams.
                </p>
              </li>
              <br /> */}
              <li>
                <p>Neosao Services Pvt Ltd (July 2022 - Present)</p>
                <p>Software Developer</p>
                <p>
                  As a pivotal contributor at Neosao Services Pvt. Ltd., I have leveraged my expertise in the MERN stack (MongoDB, Express.js, React.js, Node.js) and Next.js to drive the development and enhancement of various technological solutions.
                </p>
              </li>
              <br />
              <li>
                <p>
                  <span style={{ fontWeight: "bold" }}>Indians Abroad App:</span> Developed APIs and an admin site for this application, which provides a platform for Indian expatriates to connect, share information, and access community services. The admin site features comprehensive management tools for user engagement and content moderation.
                </p>
              </li>
              <br />
              <li>
                <p>
                  <span style={{ fontWeight: "bold" }}>IOT Services:</span> Contributed to the development of IOT-based solutions, integrating various devices and sensors with web applications to provide real-time monitoring and data analytics. This included the creation of APIs and websocket events to manage device communication and data processing.
                </p>
              </li>
              <br />
            </ul>
      ...
      <Heading
        ...
        fontFamily={"Signika Negative, sans-serif"}
      >
        My <span style={{ color: "#dc143c" }}>Timeline</span>
      </Heading>
      ...
      <VerticalTimeline lineColor={`${TimeLineColor}`}>
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">
            Leveraging MERN stack (MongoDB, Express, React, Node.js),
            I built and deployed full-stack web applications, ensuring smooth data flow and user interaction.
          </h4>
        </VerticalTimelineElement>
        ...
        >
          ...
          <h4 className="vertical-timeline-element-subtitle">
            Asagaon Madhyamik Vidyalaya, Asagaon.
          </h4>
          <h4 className="vertical-timeline-element-subtitle">
            Chandgad, Maharashtra, India
          </h4>
          <h4>Maths, Science, English, Hindi, Social Studies</h4>
          <h4>SSC Board</h4>
          <h4>Percentage :- 90.4%</h4>
        </VerticalTimelineElement>
